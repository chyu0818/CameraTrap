...
from data_reader import CameraTrapCropTripletDataset, CameraTrapCropTripletDatasetNew
...
# Batch all, batch hard
print('Train Data')
train_dataset = CameraTrapCropTripletDatasetNew(img_path, train_path, ann_path, bbox_path,
                                  percent_data, conf_threshold=0.5, transform=transform_train)
print('\nVal Cis-Location Data')
val_cis_dataset = CameraTrapCropTripletDatasetNew(img_path, val_cis_path, ann_path, bbox_path,
                                  percent_data, conf_threshold=0.5, transform=transform_val)

print('\nVal Trans-Location Data')
val_trans_dataset = CameraTrapCropTripletDatasetNew(img_path, val_trans_path, ann_path, bbox_path,
                                  percent_data, conf_threshold=0.5, transform=transform_val)
